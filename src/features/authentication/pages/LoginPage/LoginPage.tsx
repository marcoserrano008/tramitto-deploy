...
const LoginPage = () => {
  ...
  // --- NEW: Helper function to auto-fill credentials ---
  const handleFillDemo = () => {
    setEmail("estudiante@umss.edu.bo");
  ...
  return (
    <div className={styles.loginContainer}>
      <div className={styles.brandingPanel}>
        {/* ... (Previous branding content remains unchanged) ... */}
        <div className={styles.brandingContent}>
          ...
          <div className={styles.welcomeSection}>
            <h2 className={styles.welcomeTitle}>¡Bienvenido al Sistema de Información de Trámites!</h2>
          ...
          {/* ... Features section hidden for brevity (remains the same) ... */}
          <div className={styles.featuresSection}>
            {/* Keep your SVG icons and text here */}
          </div>
        ...
        <div className={styles.loginForm}>
          ...
          <div className={styles.demoBox}>
            <div className={styles.demoText}>
              ...
              <span>Correo: estudiante@umss.edu.bo</span>
              <span>Contraseña: 123456789</span>
            </div>
          ...
          <button
            ...
            className={classNames(styles.loginButton, styles.registerButton)}
          >
            Registrarse
          </button>
        </div>
